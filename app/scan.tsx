...
const styles = StyleSheet.create({
  safe: { flex: 1 },
  content: { paddingHorizontal: 20, paddingTop: 10, paddingBottom: 48, gap: 19 },
  ...
  subtitle: { marginTop: 9, maxWidth: 330, fontSize: 13.25, lineHeight: 19.5, textAlign: 'center' },
  ...
  emptyBody: { marginTop: 7, maxWidth: 300, textAlign: 'center', fontSize: 12.25, lineHeight: 18 },
