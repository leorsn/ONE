...
const styles = StyleSheet.create({
  ...
  navMeta: { fontSize: 10.5, fontWeight: '650' },
  chat: { flex: 1 },
  ...
  exampleText: { flex: 1, fontSize: 14, fontWeight: '650' },
  ...
  answerEyebrow: { fontSize: 11, fontWeight: '850', letterSpacing: 0.5 },
  ...
  sourcesLabel: { fontSize: 9.5, fontWeight: '850', letterSpacing: 0.6, marginBottom: 3 },
  sourceRow: { minHeight: 50, flexDirection: 'row', alignItems: 'center', gap: 10 },
  sourceTitle: { fontSize: 13.5, fontWeight: '750' },
